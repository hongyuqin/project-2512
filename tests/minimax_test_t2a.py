...
if __name__ == "__main__":
    ...
    text_to_speech(
        api_key=API_KEY,
        text="闭上眼睛，感受呼吸的流动。吸气时，想象温暖的光充满全身；呼气时，释放所有紧绷与杂念。将注意力轻轻落在眉心，如同观察云朵飘过，不评判、不追逐。默念：“此刻，我安然存在。”若思绪游离，温柔地带回呼吸。感受身体与地面的接触，如大树扎根大地。最后，深吸一口气，慢慢睁开眼，带着宁静回归当下。",
